...
if (isset($_POST['form1'])) {
	...
	if (empty($_POST['nhanhieu'])) {
		...
		if (empty($_POST['nhanhieu'])) {
			...
			$apiUrl = 'http://localhost:8080/api-admin/controller-nhanhieu/edit';
			$ch = curl_init($apiUrl);
			...
			if ($responseData === null) {
				...
				$success_message = 'Thay đổi Nhãn hiệu thành công.';
			}
		}
	}
}
...
$apiUrl = 'http://localhost:8080/api-admin/controller-nhanhieu/show-id';
$data = array(
	'id' => $_REQUEST['id']
);
$ch = curl_init($apiUrl);
...
// print_r( $responseData);
	$nhanhieu = $responseData['data']['nhanhieu'];
